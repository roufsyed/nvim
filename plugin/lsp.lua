...
require("mason-lspconfig").setup {
	ensure_installed = { "lua_ls", "ts_ls", "gopls", "rust_analyzer", "html", "cssls", "jdtls", "kotlin_language_server" } -- Add LSPs you need
}
...
vim.keymap.set("n", "D<Space>", vim.lsp.buf.code_action, opts)  -- Show available code actions
...
vim.keymap.set("n", "<leader>e", vim.diagnostic.open_float, opts)  -- Show diagnostics in a popup
...
vim.keymap.set("n", "<leader>oi", function() vim.lsp.buf.execute_command({ command = "_typescript.organizeImports" }) end, opts)  -- Organize imports (TypeScript-specific)
